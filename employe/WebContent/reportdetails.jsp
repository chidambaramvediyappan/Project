...
for(Employee emp : emplist1){
	out.println("<tr> <td>"+emp.getName()+"</td><td>"+emp.getAge()+"</td><td>"+emp.getDataofbirth()+"</td><td>"+emp.getAddress()+"</td><td>"+emp.getSalary()+"</td><td>"+emp.getDescription()+"</td><td>"+emp.getEmail()+"</td><td>"+emp.getPhone()+"</td></tr>");
}	
%>
</table>
</body>
